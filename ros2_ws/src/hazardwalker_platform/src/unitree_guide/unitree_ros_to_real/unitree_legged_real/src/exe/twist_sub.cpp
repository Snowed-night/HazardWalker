...
// 双订阅：原始cmd_vel + /hw/cmd_vel
ros::Subscriber sub_cmd_vel_raw;
ros::Subscriber sub_cmd_vel_hw;
...
void cmdVelCallback(const geometry_msgs::Twist::ConstPtr &msg)
{
    ...
    // 只发布原生 high_state，无/hw/high_state
...
int main(int argc, char **argv)
{
    ...
    // 两个订阅通道，共用回调
    sub_cmd_vel_raw = nh.subscribe("cmd_vel", 1, cmdVelCallback);
    sub_cmd_vel_hw = nh.subscribe("/hw/cmd_vel", 1, cmdVelCallback);

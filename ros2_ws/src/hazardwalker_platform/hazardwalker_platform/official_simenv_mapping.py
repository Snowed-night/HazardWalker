...
# 原始 /Odometry_gazebo 在官方场景中频率很高；启动补丁先将其压缩为仅包含最新值的
# /hazardwalker/odom，避免 rosbridge 回放启动期的历史位姿。
OFFICIAL_ROS1_TO_HW: Tuple[TopicMapping, ...] = (
    TopicMapping('/hazardwalker/odom', '/hw/odom', 'nav_msgs/Odometry', 'ros1_to_ros2'),

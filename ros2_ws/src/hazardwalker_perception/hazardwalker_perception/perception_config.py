...
_DIRECT_SECTIONS = {
    ...
    'localization': {
        ...
        'min_sphere_depth_shape_points', 'min_sphere_depth_shape_bbox_px',
        'min_sphere_axis_depth_points',
        'min_sphere_axis_curvature_ratio', 'sphere_radius_m',
        'occluded_sphere_min_depth_separation_m',
        'occluded_sphere_min_circularity',
        'occluded_sphere_min_aspect_ratio',
        'occluded_sphere_max_extent',
        'occluded_sphere_min_red_pixel_count',

# SimEnv ROS2 RGB-D 与 world 坐标对齐修复说明（历史）

> **历史资料，禁止作为当前平台实现或定位依据。** 本文基于 2026-07-10 的 ROS2 Harmonic 临时部署；当前官方 SimEnv 使用 ROS1 Noetic + Gazebo Classic，并以 `docs/guidebook/官方SimEnv平台环境使用手册.md` 为准。

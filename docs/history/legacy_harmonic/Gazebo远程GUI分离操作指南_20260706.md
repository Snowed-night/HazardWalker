...
> 背景与原因见 [Gazebo远程运行问题报告.md](Gazebo远程运行问题报告_20260706.md)。
...
1. **安装 Gazebo Harmonic 8.x**（与 hxbl 大版本一致，当前为 8.11）  
...
- [Gazebo远程运行问题报告.md](Gazebo远程运行问题报告_20260706.md) — 原因、headless、VNC 等方案对比  
- [主力机与远程接入使用指南（临时旧版）](../../guidebook/主力机与远程接入使用指南（临时旧版）.md) — RDP、账号与 `ROS_DOMAIN_ID` 说明
